...
export function Hero() {
  ...
  return (
    <section onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} className="relative min-h-[92vh] w-full overflow-hidden bg-[#f4f3ee] flex items-center">
      ...
      <MotionDiv aria-hidden="true" className="absolute right-[7%] top-[16%] hidden xl:block h-80 w-80 [perspective:1100px]" animate={{ y: [0, -14, 0] }} transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}>
        <MotionDiv className="relative h-full w-full [transform-style:preserve-3d]" style={{ rotateX, rotateY }}>
